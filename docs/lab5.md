...
<div class="lab-quiz" id="quiz-lab5" data-final="true">
  ...
  <div class="quiz-question" data-correct="C">
    ...
    <label><input type="radio" name="q1-lab5" value="B"> B) Which files are the best modernization candidates</label><br>
    <label><input type="radio" name="q1-lab5" value="C"> C) Which unit tests need to be rewritten for Java 17</label><br>
  ...
  <!-- Question 2 -->
  <div class="quiz-question" data-correct="C">
    <p><strong>Question 2:</strong> In Lab 5, which Java file is used as the first example of domain-model modernization?</p>
    <label><input type="radio" name="q2-lab5" value="A"> A) Order.java</label><br>
    <label><input type="radio" name="q2-lab5" value="B"> B) PaymentService.java</label><br>
    <label><input type="radio" name="q2-lab5" value="C"> C) Product.java</label><br>
    <label><input type="radio" name="q2-lab5" value="D"> D) OrderService.java</label>
    <div class="quiz-feedback" hidden></div>
  </div>
  ...
  <div class="quiz-question" data-correct="C">
    ...
    <label><input type="radio" name="q3-lab5" value="A"> A) backup/ and archive/</label><br>
    <label><input type="radio" name="q3-lab5" value="B"> B) tests/ and docs/</label><br>
    <label><input type="radio" name="q3-lab5" value="C"> C) modernized/ and migration-guide/</label><br>
