...
<div class="lab-quiz" id="quiz-lab1" data-unlocks="lab2">
  ...
  <div class="quiz-question" data-correct="C">
    ...
    <label><input type="radio" name="q1-lab1" value="A"> A) Ask Mode</label><br>
    <label><input type="radio" name="q1-lab1" value="B"> B) Plan Mode</label><br>
    <label><input type="radio" name="q1-lab1" value="C"> C) Agent Mode</label><br>
  ...
  <!-- Question 2 -->
  <div class="quiz-question" data-correct="C">
    <p><strong>Question 2:</strong> What database technology does the To Do application backend use?</p>
    <label><input type="radio" name="q2-lab1" value="A"> A) PostgreSQL</label><br>
    <label><input type="radio" name="q2-lab1" value="B"> B) MySQL</label><br>
    <label><input type="radio" name="q2-lab1" value="C"> C) SQLite</label><br>
    <label><input type="radio" name="q2-lab1" value="D"> D) MongoDB</label>
    <div class="quiz-feedback" hidden></div>
  </div>
  ...
  <div class="quiz-question" data-correct="C">
    ...
    <label><input type="radio" name="q3-lab1" value="B"> B) Using only one programming language per project</label><br>
    <label><input type="radio" name="q3-lab1" value="C"> C) Writing code that is self-explanatory through clear structure, meaningful naming, and well-placed comments</label><br>
