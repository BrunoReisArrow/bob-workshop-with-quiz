...
- [Testing & Verification](#step-5-test-your-application)
...
<img alt="1" src="../assets/lab1/images/1.png">
...
<img alt="2" src="../assets/lab1/images/2.png">

<img alt="3" src="../assets/lab1/images/3.png">
...
<img alt="4" src="../assets/lab1/images/4.png">
...
<img alt="5" src="../assets/lab1/images/5.png">
...
<img alt="6" src="../assets/lab1/images/6.png">
...
<img alt="7" src="../assets/lab1/images/7.png">
...
<p align="center">
  <img src="../assets/lab1/images/8.png" alt="8" width="400"/>
</p>

Follow the instructions and run those commands in your terminal.

<img alt="9" src="../assets/lab1/images/9.png">
...
<img alt="10" src="../assets/lab1/images/10.png">

<img alt="11" src="../assets/lab1/images/11.png">

**For macOS Users**:

Right-click the `index.html` file and select "Reveal in Finder"

<img alt="12" src="../assets/lab1/images/12.png">

Then just open the file in your browser of choice.

<img alt="13" src="../assets/lab1/images/13.png">
...
<img alt="14" src="../assets/lab1/images/14.png">
...
<img alt="15" src="../assets/lab1/images/15.png">
...
<div class="lab-quiz" id="quiz-lab1" data-unlocks="lab2">

  <!-- Question 1 -->
  <div class="quiz-question" data-correct="A">
    <p><strong>Question 1:</strong> Which Bob mode is described as best for "Writing, modifying, refactoring, or improving code"?</p>
    <label><input type="radio" name="q1-lab1" value="A"> A) Agent Mode</label><br>
    <label><input type="radio" name="q1-lab1" value="B"> B) Plan Mode</label><br>
    <label><input type="radio" name="q1-lab1" value="C"> C) Ask Mode</label><br>
    <label><input type="radio" name="q1-lab1" value="D"> D) Review Mode</label>
    <div class="quiz-feedback" hidden></div>
  </div>

  <!-- Question 2 -->
  <div class="quiz-question" data-correct="B">
    <p><strong>Question 2:</strong> In Lab 1, which Bob mode should you use when you want to plan your project structure, API endpoints, and database schema before writing any code?</p>
    <label><input type="radio" name="q2-lab1" value="A"> A) Agent Mode</label><br>
    <label><input type="radio" name="q2-lab1" value="B"> B) Plan Mode</label><br>
    <label><input type="radio" name="q2-lab1" value="C"> C) Ask Mode</label><br>
    <label><input type="radio" name="q2-lab1" value="D"> D) Review Mode</label>
    <div class="quiz-feedback" hidden></div>
  </div>

  <!-- Question 3 -->
  <div class="quiz-question" data-correct="B">
    <p><strong>Question 3:</strong> According to Lab 1, what is the main goal of literate coding?</p>
    <label><input type="radio" name="q3-lab1" value="A"> A) Writing the shortest possible code with no comments</label><br>
    <label><input type="radio" name="q3-lab1" value="B"> B) Writing code that is self-explanatory through clear structure, meaningful naming, and well-placed comments</label><br>
    <label><input type="radio" name="q3-lab1" value="C"> C) Using only one programming language per project</label><br>
    <label><input type="radio" name="q3-lab1" value="D"> D) Generating code automatically without human review</label>
    <div class="quiz-feedback" hidden></div>
  </div>

  <button class="quiz-submit-btn" onclick="submitQuiz('lab1')">Submit Answers</button>
