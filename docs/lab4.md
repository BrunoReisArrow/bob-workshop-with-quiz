<div class="lab-lock-overlay" id="lock-lab4">
...
Download the lab files ZIP [here](assets/lab4/source.zip). Extract it to a new local folder and open that extracted folder in IBM Bob before starting the exercise.
...
<img alt="2" src="../assets/lab4/images/2.png">
...
<img alt="3" src="../assets/lab4/images/3.png">
...
<img alt="5" src="../assets/lab4/images/5.png">
...
<img alt="6" src="../assets/lab4/images/6.png">
...
<img alt="7" src="../assets/lab4/images/7.png">
...
<div class="lab-quiz" id="quiz-lab4" data-unlocks="lab5">
  ...
  <button class="quiz-submit-btn" onclick="submitQuiz('lab4')">Submit Answers</button>
